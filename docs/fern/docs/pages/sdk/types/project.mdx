...
<Accordion title={<span className="accordion-show-properties" />}>
  ...
  <ParamField path="passkeyEnabled" type="boolean">
    Indicates if passkey authentication is enabled for the project.
  </ParamField>
  ...
  <ParamField path="oauthProviders" type="{ id: string; }[]">
    List of OAuth providers configured for the project.
  </ParamField>
</Accordion>
